...
namespace Componentes_ProyectoGimnasioMMA.Componentes.GestionEscuelas;

public partial class SelectorEscuela : ContentView
{
    // RECURSOS
    ...
    public SelectorEscuela(bool generarBotones)
    {
        InitializeComponent();
    ...
    public SelectorEscuela(Usuario usuario, bool generarBotones)
    {
        InitializeComponent();
